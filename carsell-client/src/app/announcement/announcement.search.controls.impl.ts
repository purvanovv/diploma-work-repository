    ...
    switch (controlName) {
      case Control.MAIN_CATEGORY_ID:
        return {
          ...
          control: new FormControl(
            this.data !== undefined && Number(this.data.mainCategoryId) !== 0 ? Number(this.data.mainCategoryId) : ''
          ),
        };
      case Control.MAKE:
        return {
      ...
      case Control.SUB_CATEGORY_ID:
        return {
          name: 'subCategoryId',
          control: new FormControl(
            this.data !== undefined && Number(this.data.subCategoryId) !== 0 ? Number(this.data.subCategoryId) : ''
          ),
        };
