...
public class ValidationConstants {
	public static final String ERROR_MESSAGE_FIELD_IS_EMPTY = "Полето не е попълнено.";
	public static final String ERROR_MESSAGE_FIELD_MAXIMUM_LENGTH = "Допустимата дължина на полето е %d.";
